...
#.conv_layer.weight += lr * (torch.exp(-self.conv_layer.weight))
		self.conv_layer.weight += lr * (torch.exp(-self.conv_layer.weight-self.lower_bound) * (self.upper_bound-self.conv_layer.weight) if self.use_stabilizer else 1) 
